...
print(Fore.RESET + '''   						  ║
 ...
 ║ [ 4 ] - Генератор фамилий	  ║ ║ [ 10 ] - Генератор ников       ║ ║ [ 14 ] - Генератор городов     ║
 ║ [ 5 ] - Генератор личностей	  ║ ║ by marjaway		     ║ ║ [ 15 ] - Генератор профессий	║
 ║ [ 6 ] - Генератор почт	  ║ ║	  version - 0.1.9	     ║ ║ [ 16 ] - Выход из программы	║
 ╚════════════════════════════════╝ ╚════════════════════════════════╝ ╚════════════════════════════════╝''')
...
if command == "1":
	...
	if news == "update":
		...
		time.sleep(0.2)
		print("0.2.0 - Добавленно Генератор городов / Генератор профессий")
		time.sleep(0.2)
