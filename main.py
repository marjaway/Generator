...
print(Fore.RESET + '''
 ...
 ║ [ 5 ] - Генератор личностей	  ║ ║ [ 11 ] - Генератор почт	     ║ ║ [ 17 ] - N/A	 		 ║
 ║ [ 6 ] - Рандомайзер от 1 до 10 ║ ║ [ 12 ] - Генератор тел.номеров ║ ║ [ 18 ] - Выход из программы     ║
 ╚════════════════════════════════╝ ╚════════════════════════════════╝ ╚═════════════════════════════════╝''')
...
if command == "1":
	...
	if news == "update":
		...
		0.1.1 - Исправленно много багов / Добавлено Генерацию ссылок
		0.1.2 - Изменение названий генераторам / Добавлено Рандомайзер чисел от 1 до 10
		0.1.3 - Исправление багов
		0.1.4 - Добавлено Генератор ников / Генератор паролей / Генератор почт
		0.1.5 - Добавлено Генератор рандом улиц
		0.1.6 - Исправление багов / Изменение названий / Изменения интерфейса
		0.1.7 - Добавлено Генератор городов / Генератор профессий
		0.1.8 - Добавление загрузки при заходе в программу / Изменён порядок функций / Генератор анекдотов ( ChatGPT 4 )''')
...
if command == "16":
	print("Расскажи анекдот ( пока что можно один )\n")
